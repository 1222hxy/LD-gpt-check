...
- 🪟 Windows Intel / AMD：[下载 `ld-gpt-check_windows_amd64.zip`](https://download.yhklab.com/ld-gpt-check/latest/ld-gpt-check_windows_amd64.zip)
- 🐧 Linux 普通服务器 / VPS：[下载 `ld-gpt-check_linux_amd64.tar.gz`](https://download.yhklab.com/ld-gpt-check/latest/ld-gpt-check_linux_amd64.tar.gz)
- 🐧 Linux ARM64：[下载 `ld-gpt-check_linux_arm64.tar.gz`](https://download.yhklab.com/ld-gpt-check/latest/ld-gpt-check_linux_arm64.tar.gz)

如果镜像下载失败，可以打开 [GitHub Releases](https://github.com/1222hxy/LD-gpt-check/releases/latest) 下载同名文件。

解压后得到 `ld-gpt-check` 或 `ld-gpt-check.exe`，放到任意目录运行即可。
