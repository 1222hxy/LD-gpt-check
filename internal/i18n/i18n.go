...
var zhMessages = map[string]string{
	...
	"cc_switch_auto_using":                           "检测到 Codex 正在通过本机代理运行，已自动使用 CC Switch 当前上游配置用于统计归一：%s",
...
var enMessages = map[string]string{
	...
	"cc_switch_auto_using":                           "Detected Codex running through a local proxy; using the current CC Switch upstream for provider statistics: %s",
