...
var zhMessages = map[string]string{
	...
	"flag_model":                    "模型名称；不填则使用 Codex 本地配置默认模型",
	...
	"wizard_model":                  "模型",
	"wizard_model_default":          "Codex 本地默认",
	"wizard_effort":                 "推理强度",
	"wizard_tests":                  "测试次数",
	"wizard_timeout":                "每轮超时",
...
var enMessages = map[string]string{
	...
	"flag_model":                    "model name; omit to use the Codex local default",
	...
	"wizard_model":                  "Model",
	"wizard_model_default":          "Codex local default",
