...
var zhMessages = map[string]string{
	...
	"flag_effort":                                    "推理强度；可用 low、medium、high、xhigh，也可输入中转站/模型支持的自定义值",
	"flag_backend":                                   "测试后端：auto、codex、api、auth-json",
	"flag_auth_json":                                 "使用 OpenAI 官方渠道（登录账号版，读取本机 Codex auth.json）测试",
	"flag_auth_path":                                 "Codex auth.json 路径；不填则使用 CODEX_HOME/auth.json 或 ~/.codex/auth.json",
	...
	"cc_switch_auto_using":                           "检测到 Codex 正在通过本机代理运行，本次将使用 CC Switch 当前上游配置用于统计归一：%s",
	...
	"usage":                                          "LD-gpt-check\n\n用法：\n  ld-gpt-check setup [--lang zh-CN|en]\n  ld-gpt-check login [--api-base-url URL] [--lang zh-CN|en]\n  ld-gpt-check run [--backend auto|codex|api|auth-json] [--auth-json] [--auth-path FILE] [-m MODEL] [--api-format openai-chat|openai-responses|anthropic-messages] [--model-api-base-url URL] [--model-api-key KEY] [--codex-args ARGS] [--suite candy_21] [--question-file FILE] [--question-url URL] [--no-remote-questions] [-r EFFORT] [-n TESTS] [--timeout 30m] [--upload] [--json]\n  ld-gpt-check run --list-suites [--question-file FILE] [--question-url URL] [--no-remote-questions]\n  ld-gpt-check doctor [--auth-json] [--auth-path FILE]\n  ld-gpt-check update [--yes|--check-only]\n  ld-gpt-check config\n  ld-gpt-check whoami\n  ld-gpt-check logout",
	...
	"wizard_backend_codex_auto":                      "已检测到 Codex 环境，本次向导将直接使用本机 Codex CLI。",
	"wizard_backend_api":                             "2) API 模式（无需本机 Codex）",
	"wizard_backend_api_numbered":                    "%s) API 模式（使用模型 API Key）",
	"wizard_backend_auth_json":                       "%d) OpenAI 官方渠道（登录账号版，读取本机 Codex auth.json）",
	"wizard_backend_api_primary":                     "1) API 模式（无需本机 Codex）",
	"wizard_backend_exit":                            "2) 暂不测试，退出向导",
	"wizard_backend_exit_numbered":                   "%s) 暂不测试，退出向导",
	"wizard_backend_invalid":                         "请输入有效测试方式序号，或输入 api / auth-json / codex。",
	"wizard_model":                                   "模型",
	...
	"wizard_done":                                    "向导完成。",
	"wizard_press_q_exit":                            "按 q 退出",
	"wizard_ready_run":                               "准备开始本地 Codex 测试。",
	"wizard_cc_switch_detected":                      "检测到 CC Switch 当前上游：%s",
	"wizard_cc_switch_note":                          "Codex 当前指向本机代理 %s；这通常是 CC Switch 接管配置。为了让上传统计归到真实中转站，可以读取 %s 中的当前上游配置。",
	"wizard_cc_switch_installed_note":                "检测到已安装 CC Switch，并从 %s 读取到当前上游配置。上传统计可以使用这个真实中转站，而不是本机代理地址。",
	"wizard_cc_switch_api_use":                       "未检测到 codex 命令；是否沿用 CC Switch 当前上游作为 API Base URL 继续测试",
	"wizard_cc_switch_use":                           "是否使用 CC Switch 当前上游配置用于上传统计",
	"wizard_cc_switch_using":                         "将使用 CC Switch 当前上游配置：%s",
	"wizard_cc_switch_key_using":                     "已从 CC Switch 读取 API Key，本次仅在内存中使用，不会保存或上传。",
	"wizard_cc_switch_skipped":                       "已保留 Codex 当前本机代理配置；上传时不会把它自动归一到 CC Switch 上游。",
	"wizard_extracted_config":                        "已提取配置",
	"wizard_extracted_backend":                       "测试方式",
	"wizard_extracted_base_url":                      "API Base URL",
	"wizard_extracted_api_format":                    "API 格式",
	"wizard_extracted_auth_json":                     "auth.json",
	"wizard_extracted_credential":                    "凭据来源",
	"wizard_config_source_cc_switch":                 "CC Switch 当前上游配置",
	"wizard_config_source_auth_json":                 "OpenAI 官方登录配置",
	"wizard_config_source_codex_cli":                 "本机 Codex CLI 配置",
	"wizard_credential_cc_switch_key":                "CC Switch API Key（已隐藏，仅本次运行内存使用）",
	"wizard_credential_env_key":                      "环境变量 LD_GPT_CHECK_MODEL_API_KEY（已隐藏）",
	"wizard_credential_manual_key":                   "手动输入的 API Key（已隐藏）",
	"wizard_credential_auth_json":                    "auth.json（OpenAI 官方登录账号版）",
	"wizard_credential_codex_cli":                    "Codex CLI 自行处理登录态",
	"wizard_codex_found":                             "检测到本机 Codex：%s",
	"wizard_codex_missing":                           "未检测到本机 Codex；可以改用 API 模式测试。",
	"wizard_codex_config_path":                       "Codex 配置文件",
	"wizard_codex_config_provider":                   "Codex 当前渠道",
	"wizard_codex_config_notice":                     "本次只读取 Codex 配置用于模型检测和上传统计归因，不会从这里读取或保存 API Key。",
	"wizard_codex_config_read_failed":                "读取 Codex 配置失败：%v",
	"wizard_auth_json_found":                         "检测到 OpenAI 官方渠道登录凭据：%s（access_token：%s）",
	"wizard_use_api":                                 "是否使用 API 模式测试",
	"wizard_need_api_without_codex":                  "没有 Codex 环境时需要使用 API 模式才能继续测试。",
	"wizard_ready_api_run":                           "准备开始 API 测试。",
	"wizard_ready_auth_json_run":                     "准备开始 OpenAI 官方渠道（登录账号版）测试。",
	...
	"prompt_effort":                                  "请输入非空推理强度；常见值为 low, medium, high, xhigh，也可填写模型支持的自定义值。",
	...
	"yes":                                            "是",
	"no":                                             "否",
	"wizard_record_title":                            "向导运行记录",
	"wizard_record_section_config":                   "配置",
	"wizard_record_section_question":                 "题目",
	"wizard_record_section_result":                   "结果",
	"wizard_record_backend":                          "测试方式",
	"wizard_record_backend_codex":                    "本机 Codex CLI",
	"wizard_record_backend_api":                      "API 模式",
	"wizard_record_backend_auth_json":                "OpenAI 官方渠道（登录账号版）",
	"wizard_record_api_format":                       "API 格式",
	"wizard_record_api_format_chat":                  "OpenAI Chat Completions",
	"wizard_record_api_format_responses":             "OpenAI Responses",
	"wizard_record_api_format_anthropic":             "Anthropic Messages",
	"wizard_record_api_base":                         "API Base",
	"wizard_record_model":                            "模型",
	"wizard_record_codex_args":                       "Codex 参数",
	"wizard_record_effort":                           "推理强度",
	"wizard_record_tests":                            "测试次数",
	"wizard_record_timeout":                          "每轮超时",
	"wizard_record_upload":                           "上传结果",
	"wizard_record_anonymous":                        "匿名展示",
	"wizard_record_question_title":                   "标题",
	"wizard_record_question_id":                      "题目 ID",
	"wizard_record_question_version":                 "版本",
	"wizard_record_question_source":                  "来源",
	"wizard_record_question_source_classic":          "经典题",
	"wizard_record_question_source_remote":           "远程题",
	"wizard_record_accuracy":                         "正确率",
	"wizard_record_correct":                          "正确",
	"wizard_record_avg_time":                         "平均耗时",
	"wizard_record_avg_tps":                          "平均 TPS",
	"wizard_record_tokens":                           "Token",
	"wizard_record_tokens_value":                     "输入 %.0f / 输出 %.0f / 推理 %.0f",
	"wizard_record_upload_status":                    "上传状态",
	"runner_model_required":                          "缺少模型名称；请使用 -m 或 --model 指定",
	"runner_backend_invalid":                         "无效的测试后端 %q；可选值：auto、codex、api、auth-json",
	...
	"runner_auth_json_load_failed":                   "读取 Codex auth.json 失败（%s）：%v",
	"runner_auth_json_access_missing":                "Codex auth.json 中没有 access_token：%s",
	"runner_auth_json_access_missing_refresh_failed": "Codex auth.json 中没有 access_token，且使用 refresh_token 自动刷新失败：%s（%v）",
	"runner_auth_json_access_expired":                "Codex auth.json 中的 access_token 已过期且自动刷新失败：%s（%v）；请先打开 Codex/ChatGPT 重新登录或刷新凭证",
	"runner_auth_json_auth_failed":                   "Auth JSON 认证失败：HTTP %d：%s。请确认本机 Codex 登录态仍有效，或重新登录后再试。",
	"doctor_codex_cli":                               "Codex CLI：%s",
	"doctor_auth_json_title":                         "Auth JSON：",
	"doctor_auth_json_file_found":                    "  文件：已找到",
	"doctor_auth_json_file_missing":                  "  文件：未找到（%s）",
	"doctor_auth_json_path":                          "  路径：%s",
	"doctor_auth_json_auth_mode":                     "  auth_mode：%s",
	"doctor_auth_json_token":                         "  access_token：%s",
	"doctor_auth_json_refresh":                       "  refresh_token：%s",
	"doctor_auth_json_id":                            "  id_token：%s",
	"doctor_auth_json_status":                        "  access_token_status：%s",
	"doctor_auth_json_exp":                           "  access_token_exp：%s",
	"doctor_auth_json_email":                         "  email：%s",
	"doctor_auth_json_plan":                          "  plan：%s",
	"doctor_present":                                 "存在",
	"doctor_missing":                                 "缺失",
	"runner_bad_effort":                              "无效的推理强度 %q；请输入非空值，例如 low、medium、high、xhigh，或模型支持的自定义值",
...
var enMessages = map[string]string{
	...
	"flag_effort":                                    "reasoning effort; low, medium, high, xhigh, or a custom value supported by the model/provider",
	"flag_backend":                                   "test backend: auto, codex, api, auth-json",
	"flag_auth_json":                                 "use the official OpenAI login-account channel from local Codex auth.json",
	"flag_auth_path":                                 "Codex auth.json path; defaults to CODEX_HOME/auth.json or ~/.codex/auth.json",
	...
	"cc_switch_auto_using":                           "Detected Codex running through a local proxy; this run will use the current CC Switch upstream for provider statistics: %s",
	...
	"wizard_backend_codex_auto":                      "Detected a Codex environment; this wizard will use the local Codex CLI directly.",
	"wizard_backend_api":                             "2) API mode (no local Codex required)",
	"wizard_backend_api_numbered":                    "%s) API mode (uses a model API key)",
	"wizard_backend_auth_json":                       "%d) Official OpenAI channel (login-account mode, local Codex auth.json)",
	"wizard_backend_api_primary":                     "1) API mode (no local Codex required)",
	"wizard_backend_exit":                            "2) Skip test and exit the wizard",
	"wizard_backend_exit_numbered":                   "%s) Skip test and exit the wizard",
	"wizard_backend_invalid":                         "Enter a valid test mode number, or type api / auth-json / codex.",
	"wizard_model":                                   "Model",
	...
	"wizard_press_q_exit":                            "Press q to exit",
	"wizard_ready_run":                               "Ready to start the local Codex test.",
	"wizard_cc_switch_detected":                      "Detected current CC Switch upstream: %s",
	"wizard_cc_switch_note":                          "Codex currently points to local proxy %s. This usually means CC Switch took over the config. To attribute uploads to the real bridge, this tool can read the current upstream from %s.",
	"wizard_cc_switch_installed_note":                "Detected an installed CC Switch and read the current upstream from %s. Upload statistics can use this real bridge instead of a local proxy address.",
	"wizard_cc_switch_api_use":                       "codex command was not detected; use the current CC Switch upstream as the API base URL and continue testing",
	"wizard_cc_switch_use":                           "Use the current CC Switch upstream for upload statistics",
	"wizard_cc_switch_using":                         "Using current CC Switch upstream: %s",
	"wizard_cc_switch_key_using":                     "Read the API key from CC Switch for this run only; it will not be saved or uploaded.",
	"wizard_cc_switch_skipped":                       "Kept the current Codex local proxy config; uploads will not be automatically attributed to the CC Switch upstream.",
	"wizard_extracted_config":                        "Extracted config",
	"wizard_extracted_backend":                       "Test mode",
	"wizard_extracted_base_url":                      "API base URL",
	"wizard_extracted_api_format":                    "API format",
	"wizard_extracted_auth_json":                     "auth.json",
	"wizard_extracted_credential":                    "Credential source",
	"wizard_config_source_cc_switch":                 "current CC Switch upstream config",
	"wizard_config_source_auth_json":                 "official OpenAI login config",
	"wizard_config_source_codex_cli":                 "local Codex CLI config",
	"wizard_credential_cc_switch_key":                "CC Switch API key (hidden, memory-only for this run)",
	"wizard_credential_env_key":                      "LD_GPT_CHECK_MODEL_API_KEY environment variable (hidden)",
	"wizard_credential_manual_key":                   "manually entered API key (hidden)",
	"wizard_credential_auth_json":                    "auth.json (official OpenAI login-account mode)",
	"wizard_credential_codex_cli":                    "Codex CLI handles its own session",
	"wizard_codex_found":                             "Detected local Codex: %s",
	"wizard_codex_missing":                           "Local Codex was not detected; API mode can be used instead.",
	"wizard_codex_config_path":                       "Codex config file",
	"wizard_codex_config_provider":                   "Codex current provider",
	"wizard_codex_config_notice":                     "This run only reads Codex config for model detection and upload attribution; it will not read or save API keys from there.",
	"wizard_codex_config_read_failed":                "Failed to read Codex config: %v",
	"wizard_auth_json_found":                         "Detected official OpenAI login credentials: %s (access_token: %s)",
	...
	"wizard_ready_auth_json_run":                     "Ready to start the official OpenAI login-account test.",
	...
	"prompt_effort":                                  "Enter a non-empty reasoning effort; common values are low, medium, high, xhigh, or a custom value supported by the model.",
	...
	"yes":                                            "yes",
	"no":                                             "no",
	"wizard_record_title":                            "Wizard Run Record",
	"wizard_record_section_config":                   "Config",
	"wizard_record_section_question":                 "Question",
	"wizard_record_section_result":                   "Result",
	"wizard_record_backend":                          "Test mode",
	"wizard_record_backend_codex":                    "Local Codex CLI",
	"wizard_record_backend_api":                      "API mode",
	"wizard_record_backend_auth_json":                "Official OpenAI channel (login-account mode)",
	"wizard_record_api_format":                       "API format",
	"wizard_record_api_format_chat":                  "OpenAI Chat Completions",
	"wizard_record_api_format_responses":             "OpenAI Responses",
	"wizard_record_api_format_anthropic":             "Anthropic Messages",
	"wizard_record_api_base":                         "API Base",
	"wizard_record_model":                            "Model",
	"wizard_record_codex_args":                       "Codex args",
	"wizard_record_effort":                           "Reasoning",
	"wizard_record_tests":                            "Test count",
	"wizard_record_timeout":                          "Timeout",
	"wizard_record_upload":                           "Upload",
	"wizard_record_anonymous":                        "Anonymous",
	"wizard_record_question_title":                   "Title",
	"wizard_record_question_id":                      "Question ID",
	"wizard_record_question_version":                 "Version",
	"wizard_record_question_source":                  "Source",
	"wizard_record_question_source_classic":          "Classic",
	"wizard_record_question_source_remote":           "Remote",
	"wizard_record_accuracy":                         "Accuracy",
	"wizard_record_correct":                          "Correct",
	"wizard_record_avg_time":                         "Avg time",
	"wizard_record_avg_tps":                          "Avg TPS",
	"wizard_record_tokens":                           "Tokens",
	"wizard_record_tokens_value":                     "input %.0f / output %.0f / reasoning %.0f",
	"wizard_record_upload_status":                    "Upload status",
	"runner_model_required":                          "model is required; pass -m or --model",
	"runner_backend_invalid":                         "invalid test backend %q; use auto, codex, api, or auth-json",
	...
	"runner_auth_json_load_failed":                   "failed to read Codex auth.json (%s): %v",
	"runner_auth_json_access_missing":                "Codex auth.json has no access_token: %s",
	"runner_auth_json_access_missing_refresh_failed": "Codex auth.json has no access_token, and automatic refresh with refresh_token failed: %s (%v)",
	"runner_auth_json_access_expired":                "Codex auth.json access_token is expired and automatic refresh failed: %s (%v); open Codex/ChatGPT and refresh the login first",
	"runner_auth_json_auth_failed":                   "Auth JSON authentication failed: HTTP %d: %s. Confirm the local Codex session is still valid, or log in again.",
	"doctor_codex_cli":                               "Codex CLI: %s",
	"doctor_auth_json_title":                         "Auth JSON:",
	"doctor_auth_json_file_found":                    "  file: found",
	"doctor_auth_json_file_missing":                  "  file: missing (%s)",
	"doctor_auth_json_path":                          "  path: %s",
	"doctor_auth_json_auth_mode":                     "  auth_mode: %s",
	"doctor_auth_json_token":                         "  access_token: %s",
	"doctor_auth_json_refresh":                       "  refresh_token: %s",
	"doctor_auth_json_id":                            "  id_token: %s",
	...
	"runner_bad_effort":                              "invalid reasoning effort %q; enter a non-empty value such as low, medium, high, xhigh, or a custom value supported by the model",
